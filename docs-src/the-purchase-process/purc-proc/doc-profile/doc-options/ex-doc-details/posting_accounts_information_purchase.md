...
- [Accounts  Related to Vendor]({{site.pp_baseurl}}/misc/accounts_related_to_vendors_pur.html)
- [Accounts  Related to Line Items]({{site.pp_baseurl}}/misc/accounts_related_to_line_items_posting_acc_info_purchase_pur.html)
...
![]({{site.pp_baseurl}}/img/lens.gif)[Precedence  of Accounts]({{site.pp_baseurl}}/misc/accounts_related_to_line_items_posting_acc_info_purchase_pur.html#precedence_vendor)


{:.see_also}
See also
: [Other  Posting Accounts Browser Information]({{site.pp_baseurl}}/misc/other_information_posting_acc_doc_info_common_sales_doc_options.html)

...
- View existing  tasks, incoming and outgoing calls, and general notes associated to the  vendor selected in a debit quote.
- Associate new  tasks, incoming and outgoing calls, and general notes to the vendor selected  in a debit quote.

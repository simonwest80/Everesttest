...
**Quantity**
: This column displays the quantity currently assigned  to the stock bin. Enter the **Quantity**  in the measure of and decimal accuracy allowed for the item in the document.   All quantities  are initially assigned to the default stock bin.
...
: If the quantity received is more than what is committed,  enter the excess quantity against the stock bin to which it has to be  assigned. The extra quantity will be displayed as [quantity] in the **Assigned** column. When you save the receipt,  serial numbers will be generated for the extra quantities.


{:.note}
You cannot detach a serial number that was attached  on a purchase order from the purchase receipt.

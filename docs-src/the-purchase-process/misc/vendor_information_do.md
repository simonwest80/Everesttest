...
**Contact**
: Specify the address of the person who is to be contacted  for information on the debit order. This field automatically displays  the default contact address specified in the **Vendor**  profile. You can select a different address.

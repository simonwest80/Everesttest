...
click the **Zoom In** ![]({{site.wm_baseurl}}/img/wh_zoom_in.gif) button to view all the document details. click the ![]({{site.wm_baseurl}}/img/wh_zoom_out.gif) **Zoom Out**  button  to hide the lower half of the price protection document. Zooming out enables  you to view all the items contained in the document.


Stock Status


Click the stock status icon in the status bar of the price protection  document to view the stock status of the items in the document.
...
This section displays whether the journal pertaining to the price protection  has been posted. When you click in this section, the **Journal 
 Transactions** browser is displayed which displays the accounting  entry pertaining to the price protection

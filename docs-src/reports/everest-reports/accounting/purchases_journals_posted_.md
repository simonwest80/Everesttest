...
# Purchase Journal (Posted)


The **Purchase** **Journal**  (**Posted**) report is similar to  the [Purchase Journal]({{site.rpt_baseurl}}/everest-reports/accounting/purchases_journals.html) report except  that it lists only transactions that are posted.


![]({{site.rpt_baseurl}}/img/lens.gif) [Purchase  Journals Posted]({{site.acc_chm}}/purchasing/purchase-jrnl-proc/common-jrnl-proc/posting/posting_purchase_journals.html)


{:.steps}
To  generate the Purchase Journal (Posted) report, do the following:

- From the main  menu bar**,** select **Reports**  > **Accounting** > **Purchase**  Journal (**Posted**). You will see  the **Purchase Journals (Posted)**  dialog box.
...
Purchase Journals (Posted) Dialog Box


Select the following parameter to view the **Purchases 
 Journals (Posted)** report.

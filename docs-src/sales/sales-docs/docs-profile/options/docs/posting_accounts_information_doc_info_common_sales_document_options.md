...
This option brings up the Posting accounts Information window that constitutes  the following two grids:

- [Accounts  Related to Customer]({{site.sp_baseurl}}/misc/accounts_related_to_customers_posting_acc_doc_info_common_sales_doc_options.html)
- [Accounts  Related to Line Items]({{site.sp_baseurl}}/misc/accounts_related_to_line_items_posting_acc_doc_info_common_sales_doc_options.html)



Use this option to view all the accounts tagged to the customer or any  of the line items in a document. You can edit the accounts in any of the  enabled columns provided you do not leave the column blank.
...
{:.note}
For an inventoried line item in the Sales transaction
...
For a non-inventoried line item in the Sales transaction
...
![]({{site.sp_baseurl}}/img/lens.gif)[Precedence  of accounts]({{site.sp_baseurl}}/misc/accounts_related_to_line_items_posting_acc_doc_info_common_sales_doc_options.html#precedence)

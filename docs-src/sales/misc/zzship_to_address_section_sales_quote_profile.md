...
This section displays the address that the items should be shipped to.  When you select a customer code, the [default shipping address](javascript:BSSCPopup('{{site.sp_baseurl}}/misc/default_shipping_address.html');){:id="a1"}<script type="text/javascript" language="JavaScript1.2"><!--
kadovFilePopupInit('a1');
//--></script>  of the customer is displayed in the **Sales 
 Quote** profile.


{:.see_also}
See also
: [Ship  to Address](JavaScript:RelatedTopics2.Click())<!--Metadata type="DesignerControl" startspan
...
<param name="Item1" value="Ship to Address;{{site.sp_chm}}/sales-docs/docs-profile/contents/customer-info/ship_to_address_customer_information_sales_document_content.html">

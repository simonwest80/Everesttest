...
Specify the General Ledger account that will be debited when a credit  memo is created with this item. Only revenue accounts are available for  selection.

...
Specify the General Ledger account that will be credited when a sales invoice is created with this item. Only revenue accounts are available for selection.

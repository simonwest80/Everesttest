...
Specify the liability account to which the local taxes payable as an  employee have to be credited. This field is disabled, if you have cleared  the **Employee** check box.

...
By default this option remains checked, if you have selected it in the **Taxes** tab of the **Employee** profile. Clear this check box, if the local tax is not applicable to the selected payroll item.

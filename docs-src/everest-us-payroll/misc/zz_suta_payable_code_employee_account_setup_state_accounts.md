...
Specify the liability account to which the SUTA tax withheld from the  employee is credited. This field is disabled, if the state does not collect  SUTA from that employee.

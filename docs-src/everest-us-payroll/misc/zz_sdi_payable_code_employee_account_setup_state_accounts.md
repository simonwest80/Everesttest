...
Specify the liability account to which the SDI tax withheld from the  employee is credited. This field is disabled, if the state does not collect  SDI from that employee.

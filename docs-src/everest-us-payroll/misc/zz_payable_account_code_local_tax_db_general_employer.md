---
title: Payable Account Code
---


Specify the liability account to which the local taxes payable as an  employer have to be credited. This field is disabled, if you have cleared  the **Employer** check box.

---
title: Tracking Choices Section
---
...
![]({{site.ct_baseurl}}/img/note.gif)  You  can reorganize the rank using the ![ct_up_arrow.gif]({{site.ct_baseurl}}/img/ct_up_arrow.gif) and ![ct_note_icon.gif]({{site.ct_baseurl}}/img/ct_note_icon.gif) arrows  provided beside the **Tracking Choices**  section.

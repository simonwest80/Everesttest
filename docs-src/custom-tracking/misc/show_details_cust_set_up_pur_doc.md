...
The **Show Details** option displays the **Tracking Selection** browser for the choice you selected. You can view all the documents tagged to that particular choice. All options in the **Tracking Selection** browser are standard browser options available with **Everest**.

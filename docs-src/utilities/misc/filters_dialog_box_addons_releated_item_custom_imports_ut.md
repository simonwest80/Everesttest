...
You can change the format of the source data characters by converting  into:
...
{:.example}
A **Filter**  field caption of **Filter: ITEM_CODE**  means that the **ITEM_CODE** column  is selected on the **Map the Source Fields**  screen.
...
Click **Next**. You will see the  **Import Data** section.


{:.see_also}
See also
: [Related Items  Import - Import Data Screen]({{site.utl_baseurl}}/db-utils/related-items-import/import-data-screen/import_data_screen_ut.html)
: [Add-on  Items Import - Import Data Screen]({{site.utl_baseurl}}/db-utils/add-on-items-import/import_data_screen_everest_addon_items_import_wizard_ut.html)
: [Custom  Tracking Import - Import Data Screen]({{site.utl_baseurl}}/db-utils/custom-tracking-import/import_data_screen_everest_custom_tracking_import_wizard_ut.html)

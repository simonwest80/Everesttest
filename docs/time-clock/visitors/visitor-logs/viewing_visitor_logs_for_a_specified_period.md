---
title: View Visitor Logs for a Specified Period
---

# View Visitor Logs for a Specified Period 


The **Visitors Log** browser allows  you to filter the records using the following fields:

...
The **Bar Code - Item Codes** option **** allows you to print item codes in the  document as barcodes. Select this option to view the **Bar****Codes** browser which displays all  the item codes attached to the document.


{:.note}
This option is not available for purchase  quotes and debit quotes.


![]({{site.pp_baseurl}}/img/steps.gif)To print an item code as a barcode, do the  following:

- From the **Purchase**/**Purchase****Return** document, select > **Options** > **Print**  > **Bar** **Code**  - **Item Code**. You will see the  **Bar Codes** browser.

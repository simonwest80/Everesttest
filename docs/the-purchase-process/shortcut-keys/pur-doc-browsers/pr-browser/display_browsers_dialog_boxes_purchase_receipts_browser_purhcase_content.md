...
| Ctrl+T | Display the **Transaction** **History** browser for the selected purchase  receipt. |
| Ctrl+U | Display the **Journal Transactions**  browser for the selected purchase receipt. |
| F3 | Display the **Document** **Printing****Preferences** dialog box. |
| F8 | Display the **Payment** **History**  for selected purchase receipt. |
| Shift+F2 | Display the **Multimedia** **Setup** browser for the selected purchase  receipt. |
| Shift+F5 | Display the **Document** **Tracking**  browser for the selected purchase receipt. |

...
| Ctrl+F | Display the **Custom** **Fields**  dialog box for the selected purchase order. |
| Ctrl+P | Display the **Browser** **Property****Editor** dialog box. |
| Ctrl+T | Display the **Transaction** **History** browser for the selected purchase  order. |
| F3 | Display the **Document** **Printing****Preferences** dialog box. |
| F8 | Display the **Payment** **History**  for selected purchase order id advance deposits have been made on it. |
| Shift+F2 | Display the **Multimedia** **Setup** browser for the selected purchase  order. |
| Shift+F5 | Display the **Document** **Tracking**  browser for the selected purchase order. |

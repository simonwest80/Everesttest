...
Specify the number of items to be given free, if the customer buys the  minimum quantity specified in the **Buy**  field at the minimum price specified in the **For 
 Amount** field.

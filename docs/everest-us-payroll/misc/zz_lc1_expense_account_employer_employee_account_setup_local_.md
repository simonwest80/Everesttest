...
Specify the expense account to which the local tax payable as an employer  is debited. This field is disabled, if the local tax is not payable by  the employee.

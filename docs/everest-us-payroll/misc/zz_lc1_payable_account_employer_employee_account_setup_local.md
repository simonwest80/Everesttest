...
Specify the liability account to which th<font color='black'>e local tax payable as an employer has to be credited. </font>This field is disabled, if the local tax is not payable by the employee.
: {:.see_also}
See also

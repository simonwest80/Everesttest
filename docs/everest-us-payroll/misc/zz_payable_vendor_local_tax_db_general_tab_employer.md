...
Specify the vendor to whom the local taxes have to be paid. This field  is disabled, if the employer does not pay this tax. This field is disabled,  if you have cleared the **Employer**  check box.

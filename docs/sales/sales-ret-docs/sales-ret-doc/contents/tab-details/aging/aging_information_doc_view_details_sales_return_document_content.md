...
Select a document and then choose the **Document 
 Payment Information** option from the right-click menu. This option  allows you to view the history of payments made on a particular document  (from the list of outstanding documents). You will see the [Payment History browser]({{site.sp_baseurl}}/sales-docs/sales-orders/so-proc/pmts-refunds/payment-history/payment_history.html).  All payments made against this document including amounts applied from  or to other documents are listed.


![]({{site.sp_baseurl}}/img/example.gif) If  part of a refund due on a credit memo has been applied to a sales invoice,  then the payment history for the credit memo will show the amount applied  to the sales invoice and the payment history for the sales invoice will  show amount applied from the credit memo.
...
The **Aging** tab displays aging  information for sales return documents that have outstanding payments  or deposits. All outstanding documents are grouped by their document type.


![]({{site.sp_baseurl}}/img/example.gif) Outstanding  credit memos and their aliases are grouped under credit memos.
...
![]({{site.sp_baseurl}}/img/example.gif) Click  on the **Document #** and you will  see a list of document number for all the documents in the<font style="font-family: Verdana;" face="verdana"><span style="font-size: 11pt;"> </span><span style="font-family: Verdana, sans-serif;">browser.</span></font>
...
//--></script>
- [Aging Option](javascript:kadovTextPopup(this)){:id="a3"}<script type="text/javascript" language="JavaScript1.2"><!--

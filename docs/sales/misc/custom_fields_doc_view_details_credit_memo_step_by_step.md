...
![]({{site.sp_baseurl}}/img/example.gif) If  a credit memo has an expiry  date that is set in the "Date" custom field, you can search  for the credit memo using the **Expiry 

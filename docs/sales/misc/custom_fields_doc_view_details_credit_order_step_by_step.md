...
# <font style="color: #000000;" color="#000000">Custom Fields</font>
...
![]({{site.sp_baseurl}}/img/example.gif) If  a credit order has an expiry  date that is set in the "Date" custom field, you can search  for the credit order using the **Expiry 

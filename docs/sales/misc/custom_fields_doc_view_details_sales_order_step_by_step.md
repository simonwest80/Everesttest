...
![]({{site.sp_baseurl}}/img/example.gif) If  a sales order has an expiry  date that is set in the "Date" custom field, you can search  for the sales order using the **Expiry 

...
**![]({{site.sp_baseurl}}/img/example.gif) If  a sales quote has an expiry  date that is set in the "Date" custom field, you can search  for the sales quote using the **Expiry 

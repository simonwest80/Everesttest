---
title: Item Purchase/Returns - Purchase Invoices
---

# Item Purchase/Returns - Purchase Invoices


Use the **Item Purchase/Returns**  option (path: **Vendors** browser  > **Options** > **History 
 &gt; Item Purchase/Returns &gt; Purchase Invoices**) to view the  purchase invoices created for the selected vendor in the **Item 
 Purchase History** browser. The items' purchase history is useful  to obtain the total quantity of items purchased.

...
The **City** field specifies the  city or town in which the vendor's address is located. This field is automatically  updated if you select a zip/postal code for the United States from the  drop-down list.

...
This option allows you to view the history of all the tracking groups  you have created for the selected item.


To view the history of all the tracking groups, choose **History 
 all group** from the right-click menu (in the **Tracking 
 Groups** section of the **Custom Tracking** - **Inventory** browser). You  will see the **Tracking Group History**  browser.

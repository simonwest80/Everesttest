...
You will see a summary break up in the form of a pie chart. The selection  break-up is indicated for all tracking choices belonging to the selected  tracking group (to which purchase documents are tagged) during the  specified date range.


Place your cursor over each slice of the pie chart to view the number  of purchase documents that are tagged to the tracking choice. You  can also view these details by turning on the data editor.
